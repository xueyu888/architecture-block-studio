...
function MultiSelectionSummary({ document, selection, onSelect }: {
  ...
  return (
    <div className="bd-multi-inspection">
      ...
      <p className="bd-multi-help">Drag empty canvas to enclose · Alt-drag intersects, even over objects · Shift/Ctrl/⌘ toggles · Edit selects direct interfaces · Drag moves · Ctrl/⌘ drag clones · Arrange aligns · Delete removes once · Ctrl/⌘ Shift+H fits · Esc clears.</p>
    </div>
  );
}
