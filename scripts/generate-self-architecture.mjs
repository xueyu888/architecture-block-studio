...
const MODULES = [
  ...
  },
  {
    ...
    principle: "Project automatic interfaces as direct segments and restore only user-authored waypoints.",
    purpose: "Keep connection geometry immediate, predictable, and manually editable without hidden routing state.",
    boundary: "Does not move modules, own gestures, avoid crossings, or persist automatic geometry.",
    failure: "Reject incomplete endpoint geometry instead of inventing a fallback route.",
  },
  {
    id: "protocols",
    groupId: "protocols",
    title: "Workbench Protocols",
    shortTitle: "Protocols",
    kind: "protocol",
    tone: "purple",
    owner: "src/studio/commands.ts · selection.ts · src/i18n",
    sourcePaths: ["src/studio/commands.ts", "src/studio/selection.ts", "src/i18n/"],
    position: { x: 340, y: 680 },
    principle: "Own the leaf contracts for command availability, canonical selection, and persisted application locale.",
    purpose: "Let menus, keyboard, Canvas, Inspector, and Studio speak one interaction and language protocol.",
  ...
  },
  {
    ...
    boundary: "Does not duplicate eligibility, selection, schema, editing, or connection-geometry rules.",
  ...
  },
  {
    ...
    purpose: "Coordinate selection, draft protection, commands, layout, connection projection, dialogs, and feedback.",
